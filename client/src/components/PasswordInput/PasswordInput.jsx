...
const PasswordInput = ({id, labelName, inputName, onChange, errorMessage}) => {
    ...
    return (
        <div className='input-wrapper'>
            <div className={`passwordinput ${errorMessage ? 'input-error' : ''}`}>
                ...
                <input className='passwordinput-input' type={isPasswordVisible? 'text' : 'password'} name={inputName} id={id} onChange={onChange} placeholder=' '/>
